...
const ConversationList: React.FC<ConversationListProps> = ({ initialItems, users }) => {
  ...
  return (
    <>
      ...
      <aside className={clsx("fixed inset-y-0 pb-20 lg:pb-0 lg:left-20 lg:w-80 lg:block overflow-y-auto border-r border-gray-200 pixel-fnt",
                        isOpen ? "hidden" : "block w-full left-0")}>
        <div className="px-5">
          <div className="flex justify-between mb-4 pt-4">
            <div className="pixel-size-l font-bold text-neutral-800">
              Messages
            </div>
