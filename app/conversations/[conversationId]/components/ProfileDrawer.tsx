  ...
  return (
    <>
      ...
      <Transition.Root show={isOpen} as={Fragment}>
        <Dialog as="div" className="relative z-50 pixel-fnt" onClose={onClose}>
                  ...
                  <Dialog.Panel className="pointer-events-auto w-screen max-w-md">
                    <div className="flex h-full flex-col overflow-y-scroll bg-white py-6 shadow-xl">
                      ...
                      <div className="relative mt-6 flex-1 px-4 sm:px-6">
                        <div className="flex flex-col items-center pixel-size-m">
                          <div className="mb-2">
                            {data.isGroup ? (
                          ...
                          <div className="text-sm text-gray-500 pixel-size-s">
                            {statusText}
                          </div>
                          <div className="flex gap-10 my-8">
                            <div onClick={() => setConfirmOpen(true)} className="flex flex-col gap-3 items-center cursor-pointer hover:opacity-75">
                              ...
                              <div className="font-light text-neutral-600 pixel-size-s">
                                Delete
                              </div>
                            </div>
                          </div>
                          <div className="w-full py-5 sm:px-0 sm:pt-0">
                            <dl className="space-y-8 px-4 sm:space-y-6 sm:px-6">
                              {data.isGroup &&
                                <div>
                                  <dt className="pixel-size-s font-medium text-gray-500 sm:w-40 sm:flex-shrink-0">
                                    Emails
                                  </dt>
                                  <dd className="mt-1 pixel-size-m text-gray-900 sm:col-span-2">
                              ...
                              {!data.isGroup && (
                                <div>
                                  ...
                                  <dd className="mt-1 text-gray-900 sm:col-span-2 pixel-size-m">
                                    {otherUser.email}
                                  </dd>
                                </div>
                              )}
